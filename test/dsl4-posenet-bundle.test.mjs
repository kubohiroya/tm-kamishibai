...
test('delegates the PoseNet manifest, verification, storage, and runtime contract to TMPose 1.9', () => {
  ...
  assert.equal(dsl4PoseNetBundleManifest.distribution.version, '1.9.0');
});
