...
/** @param {unknown} input @returns {Readonly<Record<string, string>>} */
...
export function createDsl4PoseFeedbackPresenter(options) {
  ...
  const summary = /** @type {HTMLElement} */ (document.createElement('p'));
  ...
  const status = /** @type {HTMLElement} */ (document.createElement('div'));
  ...
  /** @param {Readonly<ReturnType<typeof createDsl4PoseStateEvent>>} event */
