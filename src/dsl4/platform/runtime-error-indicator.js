 ...
 * @param {() => unknown | Promise<unknown>} [options.onReturnToMenu]
 */
export function createDsl4RuntimeErrorIndicator(options) {
  ...
  return Object.freeze({
    element: root,
    /**
     * @param {{message: unknown, code?: unknown, title?: unknown, displayName?: unknown, sourceId?: unknown, range?: unknown, path?: unknown, storyPath?: unknown, excerpt?: unknown}} diagnostic
     * @param {{returnToMenu?: boolean}} [showOptions]
     */
    show(diagnostic, showOptions = {}) {
