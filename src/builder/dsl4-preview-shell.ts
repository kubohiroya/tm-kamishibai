...
function exactRecord(value: unknown, keys: Set<string>, name: string) {
...
function previewShellOptions(value: unknown) {
...
function safeInteger(value: unknown, name: string, maximum: number) {
...
function safeText(value: unknown, name: string, maximum: number) {
  if (
    typeof value !== 'string' ||
    value.length === 0 ||
...
function nullableIntegrity(value: unknown, name: string) {
...
function normalizeChoice(value: unknown, number: string) {
...
function abbreviatedIntegrity(value: string | null) {
...
export function createDsl4DevelopmentPreviewShell(input: unknown) {
 ...
 */
export function createDsl4CliPreviewShell(input: unknown = {}) {
