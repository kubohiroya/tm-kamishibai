...
| @kubohiroya/turbowarp-tmpose             | 1.11.0            | MPL-2.0      | `kubohiroya/turbowarp-tmpose`                  |
...
JSON and weight shards are Apache-2.0 material. `@kubohiroya/turbowarp-tmpose@1.11.0` publishes the
