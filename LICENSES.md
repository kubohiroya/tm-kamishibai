...
| @kubohiroya/turbowarp-tm                 | 3.2.0             | MPL-2.0      | `kubohiroya/turbowarp-tm`                      |
...
JSON and weight shards are Apache-2.0 material. `@kubohiroya/turbowarp-tm@3.2.0` publishes the
