...
export const dsl4ReleaseVersion = '4.0.0-rc.9';
export const dsl4NextReleaseVersion = '4.0.0-rc.10';
export const dsl4ReleaseSeries = '4.0';
export const dsl4ReleaseBuildDate = '2026-08-21';
...
export const dsl4ReleaseAssetUrl =
  `https://github.com/kubohiroya/tmpose-kamishibai/releases/download/` +
