...
- **`noUncheckedIndexedAccess` leaves 83 errors** and is not adopted yet, but the measurement
  ...
  Done so far, 854 down to 83: the reload overlay, the web preview shell, the platform asset
