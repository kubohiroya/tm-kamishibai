...
- **`noUncheckedIndexedAccess` leaves 112 errors** and is not adopted yet, but the measurement
  ...
  Done so far, 854 down to 112: the reload overlay, the web preview shell, the platform asset
