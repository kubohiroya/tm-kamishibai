...
- **`noUncheckedIndexedAccess` leaves 170 errors** and is not adopted yet, but the measurement
  ...
  Done so far, 854 down to 170: the reload overlay, the web preview shell, the platform asset
