...
- **`noUncheckedIndexedAccess` leaves 183 errors** and is not adopted yet, but the measurement
  ...
  Done so far, 854 down to 183: the reload overlay, the web preview shell, the platform asset
