...
| レイヤー                 | 主なmodule                                                                                                                                                                                                                                                                                                                                                                          | 責務                                                                                                                                                         |
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| CLI／出力                | [`bin/tm-kamishibai.mjs`](../../bin/tm-kamishibai.mjs)、[`src/builder/cli.js`](../../src/builder/cli.js)、[`dsl4-build-output.js`](../../src/builder/dsl4-build-output.js)                                                                                                                                                                                                          | optionと有限上限を受け取り、入力を読み、候補SB3を再検証してatomicに置換する                                                                                  |
...
| `keyInputToChangeScene`／`touchInputToChangeScene`／`poseInputToChangeScene`／`imageInputToChangeScene` | runtime controller + input／recognition port | portから返った選択値を、台本で宣言済みのrouteだけに対応付ける                                    |
