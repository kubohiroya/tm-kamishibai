...
Web player、通常editor、Packager、development previewは同じconsumerをそれぞれのapp shell containerへ
接続し、surface固有の暗黙modeを追加しません。flag OFFまたは別modeではpresenter optionを検査しません。
